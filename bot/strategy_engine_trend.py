"""
strategy_engine_trend.py - Estrategia Trend Following original.
...
logger = setup_logger("strategy_trend")
...
class StrategyEngine:
    def __init__(self, ml_weight: float = 0.0):
        ...
        logger.info("StrategyEngine Trend inicializado | EMA 9/21 + ADX + RSI")
    ...
    def _build_signal(self, action, confidence, reasons, indicators, regime):
        ...
        logger.info(
            f"[TREND] SIGNAL: {action} | conf={confidence:.2%} | regime={regime} | "
